...
public:
	...
	// Note: aligned might be useless with std::atomic
	__aligned(4) std::atomic<unsigned int> m_ReadPos;  // cur pos gs is reading from
	__aligned(4) std::atomic<unsigned int> m_WritePos; // cur pos ee thread is writing to
